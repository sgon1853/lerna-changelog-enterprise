        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const commit of commits) {
                ...
                if (login && shouldKeepCommiter && !committers[login]) {
                    committers[login] = yield this.github.getUserData(login, this.config.githubServer);
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield pMap(commitInfos, (commitInfo) => __awaiter(this, void 0, void 0, function* () {
                if (commitInfo.issueNumber) {
                    commitInfo.githubIssue = yield this.github.getIssueData(this.config.repo, commitInfo.issueNumber, this.config.githubServer);
                }
        ...
        for (const commit of commits) {
            ...
            if (this.config.prTitleFilters && this.config.prTitleFilters.length !== 0) {
                categories = this.config.prTitleFilters
                    .filter(titleFilter => commit.githubIssue && commit.githubIssue.title.toLowerCase().indexOf(titleFilter.toLowerCase()) !== -1)
                    .map(titleFilter => titleFilter);
            }
            if (!commit.githubIssue.labels)
                continue;
