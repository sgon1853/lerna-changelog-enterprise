    ...
    describe("authentication", () => {
        describe("when github token is not valid", () => {
            ...
            beforeEach(() => {
                ...
                require("../fetch").__setMockResponses(Object.assign(Object.assign({}, usersCache), Object.keys(issuesCache).reduce((unauthorizedIssues, issue) => (Object.assign(Object.assign({}, unauthorizedIssues), { [issue]: unauthorized })), {})));
            });
            afterEach(() => {
                jest.resetAllMocks();
            });
            it("should abort with a proper error message", () => __awaiter(void 0, void 0, void 0, function* () {
                const MockedChangelog = require("../changelog").default;
                const changelog = new MockedChangelog();
                expect.assertions(2);
                try {
                    yield changelog.createMarkdown();
                }
                catch (error) {
                    expect(error).toEqual(expect.objectContaining({ message: expect.stringContaining("Fetch error: Unauthorized") }));
                    expect(error).toEqual(expect.objectContaining({ message: expect.stringContaining(JSON.stringify(badCredentials)) }));
                }
            }));
        });
    });
});
//# sourceMappingURL=markdown-full.spec.js.map