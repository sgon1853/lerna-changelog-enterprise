...
function renderer(options = {}) {
    return new markdown_renderer_1.default(Object.assign({ baseIssueUrl: "http://foo.bar/", categories: [], unreleasedName: "Unreleased" }, options));
}
function getToday() {
    return "2018-07-10";
}
describe("MarkdownRenderer", () => {
    ...
    describe("groupByCategory", () => {
        it("group commits by category", () => {
            ...
            const commitsByCategory = r["groupByCategory"](testCommits);
    ...
    describe("renderRelease", () => {
        it(`renders unreleased commits`, () => {
            const release = {
                ...
                date: getToday(),
                commits: [
                    Object.assign(Object.assign({}, BASIC_COMMIT), { categories: [":rocket: New Feature"] }),
                ],
            };
            const options = {
